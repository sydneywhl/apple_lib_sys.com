...
if(isset($_SESSION['member_id'])){
    ...
    and curdate() > borrowed_by.return_date
...
while($m=mysqli_fetch_array($execute))
{
    ...
    $return_date = new DateTime($m['return_date']);
    $due_days = $current_date->diff($return_date)->days;
    ...
    echo "<table border='1' id='size'>";
            ...
            Late for: $due_days days<br>";
            
            

    if ($_SESSION['role'] == 'ADMIN' or $_SESSION['role'] == 'STAFF') {
        echo "
        <br><a href='bookReturnProcess.php?isbn=".$m['isbn']."&member_id=".$m['member_id']."'onClick=\"return confirm('Are you sure you want to return this book?')\"'>Return Book</a>
            </td>
            </tr>";
    }
